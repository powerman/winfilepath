...
//
// This winfilepath package provides Windows path behavior on all platforms.
// On non-Windows systems, functions that require filesystem access will panic.
package winfilepath
...
import (
	...
	"github.com/powerman/winfilepath/internal/bytealg"
	"github.com/powerman/winfilepath/internal/filepathlite"
	"github.com/powerman/winfilepath/winos"
)

const (
	Separator     = winos.PathSeparator
	ListSeparator = winos.PathListSeparator
)
...
//
// On non-Windows systems, this function panics.
func Localize(path string) (string, error) {
	panic("winfilepath: Localize requires filesystem context and is not supported on non-Windows systems")
}
...
func EvalSymlinks(path string) (string, error) {
	panic("winfilepath: EvalSymlinks requires filesystem access and is not supported on non-Windows systems")
}
...
func Abs(path string) (string, error) {
	panic("winfilepath: Abs requires filesystem access and is not supported on non-Windows systems")
}
...
func WalkDir(root string, fn fs.WalkDirFunc) error {
	panic("winfilepath: WalkDir requires filesystem access and is not supported on non-Windows systems")
}
...
func Walk(root string, fn WalkFunc) error {
	panic("winfilepath: Walk requires filesystem access and is not supported on non-Windows systems")
}
